package demos.example.code.oauth2.config;


import demos.example.code.oauth2.properties.OAuth2Properties;
import demos.example.code.oauth2.security.jwt.MerryyouJwtTokenEnhancer;
...
public class TokenStoreConfig {
    ...
    /**
     * 用于存放token
     * 如果配置文件中 "merryyou.security.oauth2.storeType 值等于 redis则生效
     * @return
     */
    @Bean
    ...
    /**
     * jwt TOKEN配置信息
     * 如果配置文件中 "merryyou.security.oauth2.storeType 值等于 jwt则生效
     */
    @Configuration
    ...
    public static class JwtTokenCofnig{
        ...
        /**
         * 用于扩展JWT
         * 如果上下文中没有名称为jwtTokenEnhancer的bean则生效
         * @return
         */
        @Bean
